...
//     */
//    public static String getCodeQRCode1(String chave, String versao, String ambiente, String cpfCnpj, String dhEmi, String valorNF, String valorICMS, String digVal, String idToken, String CSC, String urlConsulta) {
//
...
//    }
     ...
     * @return String do QrCode
     */
    public static String getCodeQRCode(String chave, String ambiente, String idToken, String CSC, String urlConsulta) {
        ...
        StringBuilder ret = new StringBuilder();
        ret.append(urlConsulta).append("?p=");
        ret.append(value);
        ret.append("|").append(cHashQRCode);
        return ret.toString();
    }
     ...
     * @return String do QrCode
     */
    public static String getCodeQRCodeContingencia(String chave, String ambiente, String dhEmi, String valorNF, String digVal, String idToken, String CSC, String urlConsulta) {

        StringBuilder value = new StringBuilder();
        value.append(chave);
        value.append("|").append("2");
        value.append("|").append(ambiente);
        value.append("|").append(dhEmi.substring(8, 10));
